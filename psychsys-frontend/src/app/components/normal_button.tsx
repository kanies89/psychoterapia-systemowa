...
const ButtonN: React.FC<InputProps> = ({ type, value }) => {
    return (
            ...
            <div className="indicator flex items-center space-x-2 p-4 bg-[#58315a] shadow rounded-lg relative w-[52vh]">
                <div className="">
                    ...
                    <div className="indicator-item indicator-top mr-[26.5vh] mt-6">
                        <input type={type} value={value} className="btn font-kodchasan w-[52vh] hover:bg-bg_1
                        hover:text-black bg-bg_2 text-xl text-white input-bordered ring-2 ring-[#58315a] border-[#58315a]">
                        </input>
                    </div>
                </div>
            </div>
